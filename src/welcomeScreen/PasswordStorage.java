...
public class PasswordStorage {
    ...
    private static int ITERATION_COUNT = 150000;
    private static int DERIVED_KEY_LENGTH = 32; // specify in bytes

    private static String PBKDF_ALGO = "PBKDF2WithHmacSHA512";
